...
sub circumstance
%>
<table width=98% align="center" border="1" cellspacing="0" cellpadding="3" class=zonelovebk style="border-collapse: collapse">
<tr class=zonelovess>
...
For i=0 to 16
Response.Write "<TR class=zoneloveds><TD>&nbsp;" & theInstalledObjects(i) & "<font color=888888>&nbsp;"
select case i
case 7
