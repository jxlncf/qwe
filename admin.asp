...
<table cellpadding=0 cellspacing=0 width=158>
    ...
    <td height=25 class=menu_title onmouseover=this.className='menu_title2'; onmouseout=this.className='menu_title'; background="img/title_bg_show.gif" id=menuTitle9 onclick="showmenu_item(9)"><span>学生成绩管理</span></td>
        </tr>
        <tr>
          <td style="display:none" id='menu_item9'><div class=sec_menu style="width:158">
              <table width="97%"  border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td height="20"><img src="img/bullet.gif" width="15" height="20" align="absmiddle"><a href="class/admin.asp" target="main">成绩管理</a> | <a href="class/add.asp" target="main">录入成绩</a></td>
                </tr>
                <tr>
                  <td height="20"><img src="img/bullet.gif" width="15" height="20" align="absmiddle"><a href="class/adds.asp" target="main">批量录入</a> | <a href="class/res1.asp" target="main">修改数据</a></td>
                </tr>
              </table>
          </div>
              <div  style="width:158">
...
<table cellpadding=0 cellspacing=0 width=158>
    ...
    <td height=25 class=menu_title onmouseover=this.className='menu_title2'; onmouseout=this.className='menu_title'; background="img/title_bg_show.gif" id=menuTitle911 onclick="showmenu_item(11)"><span>在线报名管理</span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="display:none" id='menu_item6'><div class=sec_menu style="width:158">
              ...
              <div  style="width:158">
                ...
                <table width="158" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="158" height="25" background="img/admin_left_9.gif"><strong class="menu_title">&nbsp;关于程序</strong></td>
    </tr>
    <tr valign="top">
 ...
 <table width="97%"  border="0" align="center" cellpadding="0" cellspacing="0">
                         <td height="20"><img src="img/bullet.gif" width="15" height="20" align="absmiddle">当前版本：<%=webvar%></a></td>
                </tr>
                <tr>
                  <td height="20"><img src="img/bullet.gif" width="15" height="20" align="absmiddle"><a href="http://www.zonelove.net" target="main">&copy;&nbsp;<font color="#FF0000">WWW</font>.<font color="#FF00FF">ZONELOVE</font>.<font color="#0000FF">NET</font></a></td>
                </tr>
<tr>
                  <td height="20"><img src="img/bullet.gif" width="15" height="20" align="absmiddle">版本更新提示：<p>
&nbsp;<iframe name="I1" src="http://www.zonelove.net/help/1.asp" scrolling="no" border="0" frameborder="0" width="136" height="100">
</iframe></p></a></a></td>
